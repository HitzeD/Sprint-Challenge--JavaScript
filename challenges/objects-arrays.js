...
*/
const animalNames = [];
const anmalSort = zooAnimals.forEach(function(currentValue){
...
*/
const populationTotal = zooAnimals.reduce(function(count, currentValue){
  return count += currentValue.population;
}, 0);;
